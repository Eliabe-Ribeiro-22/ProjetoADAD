...
<div>
    <div>
        <p class="text-center text-font-footer olor-white">Telefones:</p>
        <p class="text-center text-font-footer olor-white"> (049) 3249-1036</p>
    </div>
...
{{-- Endereco --}}
<div id="endereco">
    <p class="text-font-footer olor-white" id="text-endereco">

...
<body>
    <nav>
        <div>
            <a href="{{ route('main.page') }}">
                <img id="logo-igreja" src="/assets/img/igreja.png" alt="Logo da Igreja">
            </a>
        </div>
        <div class="nav-logo">
    ...
    <main>
        <div class="institucional-pg">
            <h2>Sobre nós</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sit vitae ratione, omnis quae fugiat inventore doloribus, aperiam, quisquam autem ipsam. Delectus quia adipisci illum sit porro animi ab ratione.</p>
            <br><br>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sit vitae ratione, omnis quae fugiat inventore doloribus, aperiam, quisquam autem ipsam. Delectus quia adipisci illum sit porro animi ab ratione.</p>
            <br><br>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sit vitae ratione, omnis quae fugiat inventore doloribus, aperiam, quisquam autem ipsam. Delectus quia adipisci illum sit porro animi ab ratione.</p>
